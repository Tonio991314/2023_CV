...
def plot_learning_curve(logfile_dir, result_lists):
    ...
    ################################################################
    # Training Accuracy
    plt.plot([acc.detach().cpu().numpy() for acc in result_lists['train_acc']], label='train')
    plt.title('Training Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig(f'{logfile_dir}/train_acc.png')
    plt.clf()

    # Training Loss
    # plt.plot([loss.detach().cpu().numpy() for loss in result_lists['train_loss']], label='train')
    plt.plot(result_lists['train_loss'], label='train')
    plt.title('Training Loss')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'{logfile_dir}/train_loss.png')
    plt.clf()

    # Validation Accuracy
    plt.plot([acc.detach().cpu().numpy() for acc in result_lists['val_acc']])
    plt.title('Validation Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.savefig(f'{logfile_dir}/val_acc.png')
    plt.clf()

    # Validation Loss
    # plt.plot([loss.detach().cpu().numpy() for loss in result_lists['val_loss']])
    plt.plot(result_lists['val_loss'], label='train')
    plt.title('Validation Loss')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.savefig(f'{logfile_dir}/val_loss.png')
    plt.clf()
